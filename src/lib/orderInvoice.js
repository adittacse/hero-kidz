export const orderInvoiceTemplate = ({ orderId, items, totalPrice }) => {
    return `<table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4; padding:20px; font-family:Arial;">
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; padding:20px; border-radius:8px;">
                  ...
                  <tr>
                    <td align="center" style="padding-bottom:20px;">
                      <img src="https://i.ibb.co.com/mrRSFrK1/image.png" alt="logo" width="120" />
